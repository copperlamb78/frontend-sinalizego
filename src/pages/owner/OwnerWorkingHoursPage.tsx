              ...
              >
                ...
                <div className="flex items-center gap-3 w-48 shrink-0">
                  <button
                    ...
                    className={cn(
                      'w-11 h-6 rounded-full transition-colors relative cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-offset-2 focus-visible:ring-offset-[#0B1120]',
